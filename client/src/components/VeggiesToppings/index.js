...
const VeggiesToppings = ({ categories, test }) => {

  //DELETE A VEGGIE TOPPING
  ...
  //DISPLAY ALL VEGGIE CATEGORY TOPPINGS FROM DATABASE
  return (
    <>
      ...
      {filterToppings().map((category) =>
        category.toppings.map((topping) => (
          ...
          <div key={topping._id} className="my-5 mx-5 card max-auto" style={{ maxWidth: 225 }}>
...
export default VeggiesToppings;